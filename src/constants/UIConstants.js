...
export const SCORE_FONT = { font: '64px Gloria Hallelujah', fill: '#fff' };
export const SCORE_TEMPLATE = time => `Time: ${time}s`;

export const GAMEOVER_TITLE_FONT = { font: '112px Gloria Hallelujah', fill: '#fff' };
export const GAMEOVER_SCORE_FONT = { font: '64px Gloria Hallelujah', fill: '#fff', align: 'center', boundsAlignV: 'middle' };
