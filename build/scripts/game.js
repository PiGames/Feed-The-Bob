...
var GameUI = function () {
  ...
  _createClass(GameUI, [{
    ...
    value: function initScore() {
      this.textScore = this.game.add.text(30, this.game.world.height - 20, (0, _UIConstants.SCORE_TEMPLATE)(this.score), _UIConstants.SCORE_FONT);
    ...
    value: function initPauseScreen() {
      ...
      this.screenPausedText = this.game.add.text(this.game.world.width * 0.5, 100, 'Paused', _UIConstants.NUTRITION_BAR_INFO_FONT);
    ...
    value: function initGameoverScreen() {
      ...
      this.screenGameoverText = this.game.add.text(this.game.world.centerX, 100, 'Game over', _UIConstants.GAMEOVER_TITLE_FONT);
      ...
      this.screenGameoverScore = this.game.add.text(this.game.world.centerX, this.game.world.centerY, 'Score: ' + this.score, _UIConstants.GAMEOVER_SCORE_FONT);
    ...
    value: function stateGameover(msg) {
      ...
      _StorageManager.PPTStorage.setHighscore('EPT-highscore', this.score);
    }
  }, {
    key: 'stateRestart',
...
},{"../constants/UIConstants":6,"../utils/AudioManager":20,"../utils/StorageManager":22}],2:[function(require,module,exports){
'use strict';
...
},{"../constants/NutritionConstants":5,"../constants/UIConstants":6,"../constants/WeightBreakpoints":7}],3:[function(require,module,exports){
"use strict";
...
var SCORE_FONT = exports.SCORE_FONT = { font: '64px Gloria Hallelujah', fill: '#fff' };
var SCORE_TEMPLATE = exports.SCORE_TEMPLATE = function SCORE_TEMPLATE(time) {
  return 'Time: ' + time + 's';
};

var GAMEOVER_TITLE_FONT = exports.GAMEOVER_TITLE_FONT = { font: '112px Gloria Hallelujah', fill: '#fff' };
var GAMEOVER_SCORE_FONT = exports.GAMEOVER_SCORE_FONT = { font: '64px Gloria Hallelujah', fill: '#fff', align: 'center', boundsAlignV: 'middle' };
...
},{"./states":19}],9:[function(require,module,exports){
'use strict';
...
},{"../constants/NutritionConstants":5,"../constants/WeightBreakpoints":7}],10:[function(require,module,exports){
'use strict';
...
},{"../constants/FoodConstants":4}],11:[function(require,module,exports){
'use strict';
...
},{"../constants/DifficultyLevelIntervals.js":3,"../constants/FoodConstants":4,"../utils/MathUtils.js":21,"./Food":10}],12:[function(require,module,exports){
'use strict';
...
},{"../UI/NutritionUI":2,"../constants/NutritionConstants":5}],13:[function(require,module,exports){
'use strict';
...
var Game = function (_Phaser$State) {
  ...
  _createClass(Game, [{
    ...
    value: function create() {
      ...
      this.bob = new _Bob2.default(this.game, this.world.width / 2, this.world.height - 32, 'bob', this.NutritionManager, this.gameUI.stateGameover.bind(this.gameUI));
...
},{"../UI/GameUI":1,"../objects/Bob":9,"../objects/FoodSpawner":11,"../objects/NutritionManager":12}],15:[function(require,module,exports){
'use strict';
...
var MainMenu = function (_Phaser$State) {
    ...
    _createClass(MainMenu, [{
        ...
        value: function create() {
            ...
            _StorageManager.PPTStorage.initUnset('EPT-highscore', 0);
            var highscore = _StorageManager.PPTStorage.get('EPT-highscore') || 0;
...
},{"../utils/AudioManager":20,"../utils/StorageManager":22}],16:[function(require,module,exports){
'use strict';
...
},{"../utils/AudioManager":20}],18:[function(require,module,exports){
'use strict';
...
var Wiki = function (_Phaser$State) {
    ...
    _createClass(Wiki, [{
        ...
        value: function create() {
            ...
            (0, _UIUtils.centerObjectInHeight)(buttonPrevious, this.world);
            ...
            (0, _UIUtils.centerObjectInHeight)(buttonNext, this.world);
        }
    }, {
        key: 'clickBack',
        ...
        value: function fillGroupWithFoodData(group, index) {
            ...
            (0, _UIUtils.centerObjectInWidth)(title, this.world);
            var sprite = this.add.sprite(0, 150, _FoodConstants.FOOD_DATA[index].key);
            (0, _UIUtils.centerObjectInWidth)(sprite, this.world);
...
},{"../constants/FoodConstants":4,"../utils/AudioManager":20,"../utils/UIUtils":23}],19:[function(require,module,exports){
'use strict';
...
},{"./Boot":13,"./Game":14,"./MainMenu":15,"./Preloader":16,"./Story":17,"./Wiki":18}],20:[function(require,module,exports){
'use strict';
...
function manageAudio(mode, game) {
  switch (mode) {
    case 'init':
      {
        _StorageManager.PPTStorage.initUnset('EPT-audio', true);
        _audioStatus = _StorageManager.PPTStorage.get('EPT-audio');
  ...
  _StorageManager.PPTStorage.set('EPT-audio', _audioStatus);
...
},{"./StorageManager":22}],21:[function(require,module,exports){
"use strict";
